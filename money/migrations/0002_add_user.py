...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('money_wallet', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='wallets', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Transaction.user'
        db.add_column('money_transaction', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='transactions', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Template.user'
        db.add_column('money_template', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='templates', to=orm['auth.User']),
                      keep_default=False)
